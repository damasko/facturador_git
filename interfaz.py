...
class Ui_albaran(object):
    def setupUi(self, albaran):
        ...
        self.horizontalLayout_8.addWidget(self.rm_item)
        ...
        self.gridLayout_7.addWidget(self.cantidad, 1, 1, 1, 1)
        ...
        albaran.setTabOrder(self.precio_item, self.cantidad)
        albaran.setTabOrder(self.cantidad, self.precio_fac)
    ...
    def retranslateUi(self, albaran):
        ...
        self.addf.setText(QtGui.QApplication.translate("albaran", "⇠  Guardar/Actualizar NºFactura", None, QtGui.QApplication.UnicodeUTF8))
